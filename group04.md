...
## 2024303110121苏俊如
-课程建议：
对于一些复杂的统计方法和编程技巧，课程进度较快，部分同学可能难以跟上。
（1）实践项目的数量和多样性仍有待提高，希望能增加更多的实践机会。
（2）希望老师在课堂上可以多互动；

-课程收获：
通过这门 数据驱动的可重复性研究 课程，我掌握了Python和R语言的数据处理与可视化技能，理解了可重复性研究的核心理念。此外，我学会了使用GitHub Pages 搭建个人网站展示研究成果，体验了AI大模型的应用，并通过自动化工具（如GitHub Actions）提升了研究效率。
